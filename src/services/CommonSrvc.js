...
const currUTCObj = () => {
  ...
  const time = moment().diff(moment().startOf('day'), 'seconds');

  return {currUTCDtTmStr, currUTCDtTmNum, currUTCDtTm, currUTCYear, currUTCMnt, currUTCDay, currUTCDayOfYear, currUTCHrs, currUTCMin, currUTCSec, time};
}
...
const getUidDtTime = () => {
  ...
  const yr = curntUTC.currUTCYear - 2024;
...
module.exports = {
  genSalt, encryptStr, currUTCObj, isJsonEmpty, dltFolder, randomStrGen, getCurrNum, getUidDtTime, generateAccessToken
};
