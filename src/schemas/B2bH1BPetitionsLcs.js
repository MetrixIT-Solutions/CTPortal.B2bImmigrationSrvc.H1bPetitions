...
// --- Begin: B2B Partners - Candidate H1BPetitions Lifecycles Schema --- //
...
module.exports = mongoose.model(config.collB2bH1BPetitionsLcs, schema);
// --- End: B2B Partners - Candidate H1BPetitions Lifecycles Schema --- //
